...
namespace BioMetrixCore
{
    public class ZkemClient : IZKEM
    {
        ...
        Action<string> RaiseAttendance;

        public ZkemClient(Action<object, string> RaiseDeviceEvent)
        { this.RaiseDeviceEvent = RaiseDeviceEvent; }

        public ZkemClient(Action<string> RaiseAttendance)
        { this.RaiseAttendance = RaiseAttendance; }
        ...
        public bool Connect_Net(string IPAdd, int Port)
        {
            if (objCZKEM.Connect_Net(IPAdd, Port))
            {
                ...
                if (objCZKEM.RegEvent(1, 32767))
                {
                    ...
                    objCZKEM.SetDeviceTime2(1, DateTime.Today.Year, DateTime.Today.Month, DateTime.Today.Day, DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second);
        ...
        public bool StartVerify(int UserID, int FingerID)
        {
            ...
            return objCZKEM.StartVerify(UserID, FingerID);
           // throw new NotImplementedException();
        }
